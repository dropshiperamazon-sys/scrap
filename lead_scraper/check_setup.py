...
REQUIRED_PACKAGES = ["playwright", "requests", "bs4", "pandas", "openpyxl"]
MIN_PYTHON = (3, 10)
...
def main() -> int:
    ...
    print()
    print("All checks passed - ready to run: python -m lead_scraper.cli" if all_ok else "Fix the FAIL line(s) above before running a real scrape.")
